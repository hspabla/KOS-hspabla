...
namespace PCI {
  ...
  // BridgePCI registers - not complete (not needed here)
  // reuse BAR typedef from Device registers // 2 BARs, read/write with offset
  ...
  // BridgeCardbus registers - not needed here
